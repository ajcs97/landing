...
export type StickerItemProps = OverrideItemProps<{
  data: StageData;
  e?: DragEvent;
}>;
...
const StickerItem: React.FC<StickerItemProps> = ({ data, e, onSelect }) => {
  const { attrs } = data;
